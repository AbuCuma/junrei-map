...
有新版本时 App 首页会出现提示，点一下即可打开下载页；也可以用 [Obtainium](https://github.com/ImranR98/Obtainium) 之类的工具订阅本仓库的 Releases 自动更新。
...
* **Google 地图服务**：加载地图底图
* **GitHub**：每天最多查询一次本仓库的最新 Release，用于提示有新版本。除了普通网络连接自带的 IP 地址外不发送任何信息；可以在「关于」页关闭

如果开启实验性的 **AI 抠图**，首次还会从 GitHub 下载一次模型文件；不开启则不会有这项下载。
